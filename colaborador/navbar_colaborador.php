...
<nav class="navbar navbar-expand-lg navbar-light bg-light px-3">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="painel_colaborador.php">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item"><a class="nav-link" href="colaborador_gerenciar_questoes.php">Minhas Questões</a></li>
        <li class="nav-item"><a class="nav-link" href="colaborador_gerenciar_simulados.php">Meus Simulados</a></li>
      </ul>

      <div class="d-flex align-items-center">
        <span class="navbar-text me-2">
          Seja bem-vindo, <strong><?php echo htmlspecialchars($nome); ?></strong>
          <span class="colaborador-badge">👔 Colaborador</span>
        </span>
