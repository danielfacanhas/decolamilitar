...
<div class="container mt-4 mb-5">
  ...
  <div class="admin-header">
    <h2 style="position: relative; z-index: 1;">Bem-vindo, Colaborador <?= htmlspecialchars($_SESSION['nome']) ?>! 👋</h2>
    ...
    <!-- AÇÕES RÁPIDAS -->
      ...
      <a href="colaborador_criar_simulado.php" class="action-card">
      ...
      <a href="colaborador_gerenciar_simulado.php" class="action-card">
        <div class="action-icon">🔍</div>
        <div class="action-content">
      ...
      <a href="colaborador_gerenciar_questoes.php" class="action-card">
        <div class="action-icon">📚</div>
        <div class="action-content">
