...
<style>
    ...
    /* Editor LaTeX */
    .latex-toolbar {
      background: linear-gradient(135deg, #4d8143ff, #5f9755ff);
      border-radius: 10px;
      padding: 15px;
      margin-bottom: 10px;
      display: flex;
    ...
    .latex-toolbar {
  background: linear-gradient(135deg, #4d7a43ff, #86ce79ff);
  border-radius: 10px;
  padding: 15px;
  margin-bottom: 10px;
  display: flex;
  ...
  max-height: 400px;
  overflow-y: auto;
  box-shadow: 0 4px 8px 0 rgba(85, 190, 63, 0.42), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
