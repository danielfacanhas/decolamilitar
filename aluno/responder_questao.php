...
if (isset($_POST['responder'])) {
  ...
  $sql_salvar = "INSERT INTO respostas_usuarios (email_usuario, id_questao, resposta_usuario, correta) 
                 VALUES ('$email_usuario', $id_atual, '$resposta_usuario', $acertou)";
  mysqli_query($conn, $sql_salvar);
...
.btn-danger {
    ...
    background-color: #d44242ff !important;
    color: white !important;
...
.btn-info {
    display: inline-flex !important; /* Permite ficar ao lado de outros botões */
    justify-content: center !important; /* Centraliza o texto DENTRO do botão */
    align-items: center !important;
    border: 2px !important;
    border-radius: 50px !important;
    margin: 5px !important; /* Margem padronizada, sem o 25% que empurrava */
    padding: 8px 20px !important;
    background-color: #4b90b8ff !important;
    color: white !important;
    font-family: "Montserrat", sans-serif !important;
    font-size: 15px !important;
    transition: all 0.3s ease !important;
    text-decoration: none !important;
    width: auto !important; /* Deixa o tamanho se ajustar ao texto */
    min-width: 200px; /* Garante um tamanho mínimo bonito */
}

/* Adicione também este ajuste para o botão Próxima Questão ficar igual */
.btn-outline-primary {
...
.btn-success {
    ...
    margin: 5px !important;
    padding: 8px 15px !important;
    background-color: #61b84bff !important;
    color: white !important;
    font-family: "Montserrat", sans-serif !important;
    font-size: 15px !important;
    transition: all 0.3s ease !important;
...
.btn-secondary {
    ...
    margin: 5px !important;
    padding: 8px 15px !important;
    background-color: #529bbdff !important;
    color: white !important;
    font-family: "Montserrat", sans-serif !important;
    font-size: 15px !important;
    transition: all 0.3s ease !important;
          ...
          <form method="POST" class="questao-card">
            ...
            <?php if (empty($feedback)): ?>
              ...
              <div class="alternativas-linha">
                ...
                <label class="alternativa-inline">
                  <input type="radio" name="resposta" value="A" required>  <?= $questao['alternativa_a'] ?>
                </label>

                <label class="alternativa-inline">
                  <input type="radio" name="resposta" value="B" required>  <?= $questao['alternativa_b'] ?>
                </label>

                <label class="alternativa-inline">
                  <input type="radio" name="resposta" value="C" required>  <?= $questao['alternativa_c'] ?>
                </label>

                <label class="alternativa-inline">
                  <input type="radio" name="resposta" value="D" required>  <?= $questao['alternativa_d'] ?>
                </label>

                <?php if (!empty($questao['alternativa_e'])): ?>
                  <label class="alternativa-inline">
                    <input type="radio" name="resposta" value="E" required> <?= $questao['alternativa_e'] ?>
                  </label>
                <?php endif; ?>
            ...
            <?php if (!empty($feedback)): ?>
              <div class="text-center mt-4">
                ...
                <a href="historico_aluno.php" class="btn btn-info btn-custom me-2">
                  📊 Ver Estatísticas
                </a>
